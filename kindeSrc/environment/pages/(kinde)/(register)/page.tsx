      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderSidePanel(revealedAuthMethods) {
          ...
          if (!revealedAuthMethods || revealedAuthMethods.length === 0) {
            header.textContent = '🕵️ Sign up methods will magically appear here as you uncover them in the minefield!';
          } else {
            header.textContent = '🎯 Found ' + revealedAuthMethods.length + ' sign up method' + (revealedAuthMethods.length === 1 ? '' : 's') + '!';
          }
