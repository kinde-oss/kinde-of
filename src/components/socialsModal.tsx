...
export default function AnnoyingModal() {
  ...
  const linkedinPosts = [
    ...
    'https://www.linkedin.com/posts/heykinde_vibe-coding-is-pretty-amazing-but-have-you-activity-7358455295200645122-SDF_',
    'https://www.linkedin.com/posts/heykinde_churn-sucks-but-you-can-set-up-a-kinde-workflow-activity-7356590708272623618-QUoO',
  ];
